...
?>
  ...
  <div class="dash-content">
    ...
    if ($stmt->rowCount() > 0) {
      ...
      echo "<thead><tr><th>Supplier Name</th><th>Supplier Address</th><th>Supplier Phone</th><th>Supplier Email</th><th>Active</th><th>Action</th></tr></thead>";
      echo "<tbody>";
      while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<td> <span class='" . ($row['is_active'] == 1 ? 'row_active' : 'row_inactive') . "'>" . $row['is_active'] . "</span> </td>";
        echo "<td>";
    ...
    <div id="edit-form">
      <form action="supplier_edit.php" method="POST">
        ...
        <label for="supplier-active">Active:</label>
        <select id="supplier-active" name="supplier-active" required>
