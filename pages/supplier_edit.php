...
<?php
  ...
  $supplierActive = $_POST['supplier-active'];

  try {
    $sql = 'UPDATE supplier SET supplier_name = :supplier_name, supplier_address = :supplier_address, supplier_phone = :supplier_phone, supplier_email = :supplier_email, is_active = :supplier_active WHERE supplier_id = :supplier_id';
    ...
    $stmt->bindParam(':supplier_active', $supplierActive);
    $stmt->execute();
